...
def main():
    ...
    def overlay_live_on_partial(
        ...
        # Keep the synthetic point inside the current partial window.
    ...
    for ci, c in enumerate(coins, 1):
        ...
        for start, end, is_final in hours:
            ...
            if not is_final:
                bucket = buckets.setdefault(start, make_bucket())
                overlay_live_on_partial(bucket, start, end, c)
